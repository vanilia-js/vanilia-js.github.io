...
<code-block tabindex="0"><code><span style="color:#FF7B72">const</span><span style="color:#79C0FF"> c</span><span style="color:#FF7B72"> =</span><span style="color:#A5D6FF"> 'slots-example'</span>
...
<span style="color:#FF7B72">  let</span><span style="color:#E6EDF3"> slot </span><span style="color:#FF7B72">=</span><span style="color:#A5D6FF"> /</span><span style="color:#FF7B72">^</span><span style="color:#A5D6FF">s</span><span style="color:#FF7B72">*&#36;</span><span style="color:#A5D6FF">/</span><span style="color:#E6EDF3">.</span><span style="color:#D2A8FF">test</span><span style="color:#E6EDF3">(c.innerHTML) </span><span style="color:#FF7B72">?</span><span style="color:#A5D6FF"> 'Fallback content'</span><span style="color:#FF7B72"> :</span><span style="color:#E6EDF3"> c.innerHTML</span>
...
<span style="color:#E6EDF3">        &#x3C;</span><span style="color:#7EE787">span</span><span style="color:#79C0FF"> class</span><span style="color:#E6EDF3">=</span><span style="color:#A5D6FF">"label"</span><span style="color:#E6EDF3">>&#36;{slot}&#x3C;/</span><span style="color:#7EE787">span</span><span style="color:#E6EDF3">></span>
<span style="color:#E6EDF3">        &#x3C;</span><span style="color:#7EE787">span</span><span style="color:#79C0FF"> class</span><span style="color:#E6EDF3">=</span><span style="color:#A5D6FF">"counterValue"</span><span style="color:#E6EDF3">>&#36;{</span><span style="color:#D2A8FF">counter</span><span style="color:#E6EDF3">()}&#x3C;/</span><span style="color:#7EE787">span</span><span style="color:#E6EDF3">></span>
<span style="color:#E6EDF3">      &#x3C;/</span><span style="color:#7EE787">button</span><span style="color:#E6EDF3">></span>
<span style="color:#A5D6FF">    &#96;</span>
...
<code-block tabindex="0"><code><span style="color:#FF7B72">import</span><span style="color:#E6EDF3"> CounterBtn </span><span style="color:#FF7B72">from</span><span style="color:#A5D6FF"> './CounterBtn.jsx'</span>

<span style="color:#FF7B72">export</span><span style="color:#FF7B72"> default</span><span style="color:#FF7B72"> function</span><span style="color:#D2A8FF"> SlotsExample</span><span style="color:#FFA657">() </span><span style="color:#E6EDF3">{</span>
...
<span style="color:#FF7B72">export</span><span style="color:#FF7B72"> default</span><span style="color:#FF7B72"> function</span><span style="color:#D2A8FF"> CounterBtn</span><span style="color:#FFA657">({ children </span><span style="color:#FF7B72">=</span><span style="color:#A5D6FF"> 'Fallback content'</span><span style="color:#FFA657"> }) </span><span style="color:#E6EDF3">{</span>
...
<span style="color:#FF7B72">  return</span><span style="color:#E6EDF3"> (</span>
<span style="color:#E6EDF3">    &#x3C;</span><span style="color:#7EE787">button</span><span style="color:#79C0FF"> onClick</span><span style="color:#FF7B72">={</span><span style="color:#E6EDF3">handleClick</span><span style="color:#FF7B72">}</span><span style="color:#E6EDF3">></span>
<span style="color:#E6EDF3">      &#x3C;</span><span style="color:#7EE787">span</span><span style="color:#79C0FF"> className</span><span style="color:#FF7B72">=</span><span style="color:#A5D6FF">"label"</span><span style="color:#E6EDF3">></span><span style="color:#FF7B72">{</span><span style="color:#E6EDF3">children</span><span style="color:#FF7B72">}</span><span style="color:#E6EDF3">&#x3C;/</span><span style="color:#7EE787">span</span><span style="color:#E6EDF3">></span>
<span style="color:#E6EDF3">      &#x3C;</span><span style="color:#7EE787">span</span><span style="color:#79C0FF"> className</span><span style="color:#FF7B72">=</span><span style="color:#A5D6FF">"counterValue"</span><span style="color:#E6EDF3">></span><span style="color:#FF7B72">{</span><span style="color:#E6EDF3">counter</span><span style="color:#FF7B72">}</span><span style="color:#E6EDF3">&#x3C;/</span><span style="color:#7EE787">span</span><span style="color:#E6EDF3">></span>
<span style="color:#E6EDF3">    &#x3C;/</span><span style="color:#7EE787">button</span><span style="color:#E6EDF3">></span>
<span style="color:#E6EDF3">  )</span>
<span style="color:#E6EDF3">}</span>
...
<span style="color:#E6EDF3">&#x3C;</span><span style="color:#7EE787">template</span><span style="color:#E6EDF3">></span>
<span style="color:#E6EDF3">  &#x3C;</span><span style="color:#7EE787">button</span><span style="color:#E6EDF3"> @</span><span style="color:#79C0FF">click</span><span style="color:#E6EDF3">=</span><span style="color:#E6EDF3">"</span><span style="color:#E6EDF3">handleClick</span><span style="color:#E6EDF3">"</span><span style="color:#E6EDF3">></span>
<span style="color:#E6EDF3">    &#x3C;</span><span style="color:#7EE787">span</span><span style="color:#79C0FF"> class</span><span style="color:#E6EDF3">=</span><span style="color:#A5D6FF">"label"</span><span style="color:#E6EDF3">>&#x3C;</span><span style="color:#7EE787">slot</span><span style="color:#E6EDF3">>Fallback content&#x3C;/</span><span style="color:#7EE787">slot</span><span style="color:#E6EDF3">>&#x3C;/</span><span style="color:#7EE787">span</span><span style="color:#E6EDF3">></span>
<span style="color:#E6EDF3">    &#x3C;</span><span style="color:#7EE787">span</span><span style="color:#79C0FF"> class</span><span style="color:#E6EDF3">=</span><span style="color:#A5D6FF">"counterValue"</span><span style="color:#E6EDF3">>{{ counter }}&#x3C;/</span><span style="color:#7EE787">span</span><span style="color:#E6EDF3">></span>
<span style="color:#E6EDF3">  &#x3C;/</span><span style="color:#7EE787">button</span><span style="color:#E6EDF3">></span>
<span style="color:#E6EDF3">&#x3C;/</span><span style="color:#7EE787">template</span><span style="color:#E6EDF3">></span>
...
<code-block tabindex="0"><code><span style="color:#E6EDF3">&#x3C;</span><span style="color:#7EE787">script</span><span style="color:#E6EDF3">></span>
<span style="color:#FF7B72">  let</span><span style="color:#E6EDF3"> { children } </span><span style="color:#FF7B72">=</span><span style="color:#E6EDF3"> &#36;</span><span style="color:#D2A8FF">props</span><span style="color:#E6EDF3">()</span>
