...
</div><div class="line"><span style="color:#D2A8FF">&#36;</span><span style="color:#E6EDF3">(</span><span style="color:#FFA657">c</span><span style="color:#FF7B72"> =></span><span style="color:#E6EDF3"> {</span></div><div class="line"><span style="color:#FFA657">  c</span><span style="color:#E6EDF3">.</span><span style="color:#D2A8FF">html</span><span style="color:#E6EDF3">&#96;</span></div><div class="line"><span style="color:#E6EDF3">    &#x3C;</span><span style="color:#7EE787">button</span><span style="color:#E6EDF3">>&#36;{</span><span style="color:#D2A8FF">doubled</span><span style="color:#E6EDF3">()}&#x3C;/</span><span style="color:#7EE787">button</span><span style="color:#E6EDF3">></span></div><div class="line"><span style="color:#E6EDF3">    &#x3C;</span><span style="color:#7EE787">p</span><span style="color:#E6EDF3">>&#36;{</span><span style="color:#D2A8FF">count</span><span style="color:#E6EDF3">()} doubled is &#36;{</span><span style="color:#D2A8FF">doubled</span><span style="color:#E6EDF3">()}&#x3C;/</span><span style="color:#7EE787">p</span><span style="color:#E6EDF3">></span></div><div class="line"><span style="color:#A5D6FF">  &#96;</span></div><div class="line">
</div><div class="line"><span style="color:#FFA657">  c</span><span style="color:#E6EDF3">.</span><span style="color:#D2A8FF">onclick</span><span style="color:#FF7B72"> =</span><span style="color:#FFA657"> e</span><span style="color:#FF7B72"> =></span><span style="color:#E6EDF3"> {</span></div><div class="line"><span style="color:#FF7B72">    if</span><span style="color:#E6EDF3"> (e.target.classList.</span><span style="color:#D2A8FF">contains</span><span style="color:#E6EDF3">(</span><span style="color:#A5D6FF">'doubled'</span><span style="color:#E6EDF3">)) </span><span style="color:#D2A8FF">count</span><span style="color:#E6EDF3">(</span><span style="color:#D2A8FF">count</span><span style="color:#E6EDF3">() </span><span style="color:#FF7B72">+</span><span style="color:#79C0FF"> 1</span><span style="color:#E6EDF3">)</span></div><div class="line"><span style="color:#E6EDF3">  }</span></div><div class="line"><span style="color:#E6EDF3">},</span><span style="color:#79C0FF">c</span><span style="color:#E6EDF3">)</span></div></code></pre>
</code-block>
    ` : ''}
