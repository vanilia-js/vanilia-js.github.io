...
<span style="color:#FFA657">    c</span><span style="color:#E6EDF3">.</span><span style="color:#D2A8FF">querySelector</span><span style="color:#E6EDF3">(</span><span style="color:#A5D6FF">'output.password'</span><span style="color:#E6EDF3">).textContent </span><span style="color:#FF7B72">= </span><span style="color:#D2A8FF">password</span><span style="color:#E6EDF3">() </span><span style="color:#FF7B72">&#x26;&#x26;</span><span style="color:#D2A8FF"> password</span><span style="color:#E6EDF3">().</span><span style="color:#79C0FF">length</span><span style="color:#FF7B72"> &#x3C;</span><span style="color:#79C0FF"> 6</span><span style="color:#FF7B72"> ?</span><span style="color:#A5D6FF"> 'Password must be at least 6 characters long'</span><span style="color:#FF7B72"> :</span><span style="color:#A5D6FF"> ''</span>
<span style="color:#E6EDF3">  })</span>
